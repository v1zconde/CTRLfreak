...
function getMonth(){
	  	var drop = document.getElementById("dropdownMenuButton")
		  $(".dropdown-item").click( function() {
			 
			var dropName = $(this).text();
			console.log($(this).val(), "value value")
  ...
  <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a className="dropdown-item" name= "January" value="01">January</a>
    <a className="dropdown-item" name= "February" value="02">February</a>
    <a className="dropdown-item" name= "March" value="03">March</a>
	<a className="dropdown-item" name= "April" value="04">April</a>
    <a className="dropdown-item" name= "May" value="05">May</a>
    <a className="dropdown-item" name= "June" value="06">June</a>
	<a className="dropdown-item" name= "July" value="07">July</a>
    <a className="dropdown-item" name= "August" value="08">August</a>
    <a className="dropdown-item" name= "September" value="09">September</a>
	<a className="dropdown-item" name= "October" value="10">October</a>
    <a className="dropdown-item" name= "November" value="11">November</a>
    <a className="dropdown-item" name= "December" value="12" >December</a>
  </div>
</div>
      <Row>
        <Col size="md-12">
